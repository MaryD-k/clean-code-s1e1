...
var taskInput=document.getElementById("adding-task__input");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("current-tasks__list");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="button edit-task-btn";

    deleteButton.className="button delete-task-btn";
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #task-adding-form__input:
